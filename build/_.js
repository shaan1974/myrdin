...
{
    if (typeof _m.precompiledCode !== "undefined")
    {
        eval(decodeURIComponent(_m.rot13(_m.precompiledCode)));
    }
    else
    {
        ...
        if (_m.precompile === true)
        {
            _m.generatedPrecompiledCode = this.generateData["template"];
            _m.generatedPrecompiledCode = _m.generatedPrecompiledCode.replace("window['__TMP_JSON_" + uuid + "']", "_m.generateData.jsonData");
            _m.generatedPrecompiledCode = _m.generatedPrecompiledCode.replace("window['__TMP_" + uuid + "']=zzz;", "");
            _m.generatedPrecompiledCode += "this.generatedCode = zzz;";
            _m.generatedPrecompiledCode = _m.generatedPrecompiledCode.replace(/\t/gi, " ");

            _m.generatedPrecompiledCode = _m.rot13(encodeURIComponent(_m.generatedPrecompiledCode));
